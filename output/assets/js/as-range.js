  ...
  var selected = {
    ...
    init: function init(instance) {
      ...
      if (instance.options.range === false) {
        instance.p1.$element.on(instance.namespace + '::move', function (e, pointer) {
          _this.$arrow.css({
            left: 0,
    ...
    init: function init(instance) {
      ...
      _jquery2.default.each(instance.pointer, function (i, p) {
        ...
        if (that.opts.active === 'onMove') {
          ...
          p.$element.on(instance.namespace + '::moveEnd', function () {
            that.hide($tip);
            return false;
  ...
  var asRange = function () {
    ...
    _createClass(asRange, [{
      ...
      value: function update(options) {
        ...
        this.updating = true;
        _jquery2.default.each(['max', 'min', 'step', 'limit', 'value'], function (key, value) {
          if (options[value]) {
